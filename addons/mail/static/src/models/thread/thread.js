...
function factory(dependencies) {
    ...
    class Thread extends dependencies['mail.model'] {
        ...
        _computeLocalMessageUnreadCounter() {
            ...
            // need to trust him
            if (this.__mfield_serverLastMessageId(this) > this.__mfield_lastSeenByCurrentPartnerMessageId(this)) {
                return this.__mfield_serverMessageUnreadCounter(this);
            }
            ...
            if (this.__mfield_lastSeenByCurrentPartnerMessageId(this) < firstMessage.__mfield_id(this)) {
                const fetchedNotSeenMessages = this.__mfield_orderedMessages(this).filter(message =>
                    ...
                    message.__mfield_author(this) !== this.env.messaging.__mfield_currentPartner(this)
                );
            ...
            const maxId = this.__mfield_lastSeenByCurrentPartnerMessageId(this);
            return this.__mfield_orderedMessages(this).reduce(
                (acc, message) => acc + ((message.__mfield_id(this) > maxId && message.__mfield_author(this) !== this.env.messaging.__mfield_currentPartner(this)) ? 1 : 0),
                0
            );
        }
