...
function factory(dependencies) {
    ...
    class Message extends dependencies['mail.model'] {
         ...
         */
        _computeThreads() {
            const threads = [...this.__mfield_serverChannels(this)];
            if (this.__mfield_isHistory(this)) {
                threads.push(this.env.messaging.__mfield_history(this));
            }
            if (this.__mfield_isNeedaction(this)) {
                threads.push(this.env.messaging.__mfield_inbox(this));
            }
            if (this.__mfield_isStarred(this)) {
                threads.push(this.env.messaging.__mfield_starred(this));
            }
            if (this.env.messaging.__mfield_moderation(this) && this.__mfield_isModeratedByCurrentPartner(this)) {
                threads.push(this.env.messaging.__mfield_moderation(this));
            }
