...
class Location(models.Model):
    ...
    cyclic_inventory_frequency = fields.Integer("Inventory Frequency (Days)", default=0, help="When the next inventory should be auto-generated based on the last inventory date (if it exists, otherwise first inventory will based on the day this value is set). A value of 0 means never.")
