...
class ResConfigSettings(models.TransientModel):
    ...
    module_google_gmail = fields.Boolean("Support gmail authentication", compute="_compute_module_google_gmail")
    ...
    @api.depends('external_email_server_default')
    def _compute_module_google_gmail(self):
        for record in self:
            record.module_google_gmail = record.external_email_server_default
