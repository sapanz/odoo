...
class Survey(models.Model):
    ...
    background_url = fields.Char('Background Url', compute="_compute_background_url")
    ...
    def _compute_background_url(self):
        base_bg_url = "/survey/get_background_image/%s/0"
        for survey in self:
            survey.background_url = base_bg_url % survey.access_token if survey.background_image else False
    ...
    def _get_questions_information(self):
        ...
        For each survey question, we return
            survey_question_id : {
                ...
                - background_url : if the question's section as has background image
        ...
        for question in self.question_and_page_ids:
            ...
            questions_info[question.id] = {
                ...
                'background_url': question.background_url or self.background_url
            }
