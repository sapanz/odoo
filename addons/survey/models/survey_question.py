...
class SurveyQuestion(models.Model):
    ...
    @api.depends('survey_id.access_token', 'background_image', 'page_id', 'survey_id.background_url')
    def _compute_background_url(self):
        ...
        for question in self:
            if question.background_image or question.page_id.background_image:
                question.background_url = base_bg_url % (
                    question.survey_id.access_token,
                    question.page_id.id if question.page_id else question.id
                )
            else:
                question.background_url = question.survey_id.background_url
