...
class WebsiteSlides(WebsiteProfile):
    ...
    def channel(self, channel, category=None, tag=None, page=1, slide_type=None, uncategorized=False, sorting=None, search=None, **kw):
        ...
        values = {
            ...
            ** self.slide_channel_prepare_review_values(channel),
        }
    ...
    def slide_channel_prepare_review_values(self, channel):
        values = {
            'channel': channel,
    ...
    def slide_view(self, slide, **kwargs):
        ...
        if kwargs.get('fullscreen') == '1':
            values.update(self.slide_channel_prepare_review_values(slide.channel_id))
