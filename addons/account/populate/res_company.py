...
Only adding speciticities of basic accounting applications.
"""
...
class ResCompany(models.Model):
    ...
    def _populate(self, size):
        ...
        if not default_chart_templates:
            ...
            raise UserError(_('At least one localization is needed to be installed in order to populate the database with accounting'))
        ...
        #   * the config is complete with try_loading(), no need to adapt chen the model changes
        #   * it is way easier :-)
