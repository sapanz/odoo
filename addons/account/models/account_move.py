...
class AccountMove(models.Model):
    ...
    def get_mail_template(self):
        ...
        """
        return 'account.email_template_edi_credit_note' if any(move.move_type == 'out_refund' for move in self)\
    ...
    def action_send_and_print(self):
        return {
            ...
            'view_mode': 'form',
            'context': {
                'default_template_id': self.env.ref(self.get_mail_template()).id,
    ...
    def action_invoice_sent(self):
        ...
        """
        self.ensure_one()
        template = self.env.ref(self.get_mail_template(), raise_if_not_found=False)
        lang = False
        if template:
